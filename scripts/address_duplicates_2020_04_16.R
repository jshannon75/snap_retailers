...
stores<-read_csv("data/snap_retailers_usda_2005-2020.csv") %>%
  distinct()
...
#What stores were removed?
stores_del<-stores %>%
  anti_join(stores_combine_save,by="store_id")
